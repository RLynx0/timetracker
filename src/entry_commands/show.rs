...
pub(crate) fn show_current_entry(show_opts: &cli::Show) -> Result<()> {
...
pub(crate) fn format_time_delta(delta: &TimeDelta) -> String {
...
pub(crate) fn show_activity_range(show_opts: &cli::Show, quantity: &ActivityRange) -> Result<()> {
...
pub(crate) fn print_activitiy_table(activities: impl IntoIterator<Item = TrackedActivity>) {
